...
class CarPricesDrivewaySpider(scrapy.Spider):
    name = "car_prices_driveway"
    ...
    def start_requests(self):
        ...
        yield scrapy.http.JsonRequest(
            url=f'https://api-gateway.driveway.com/sell/v8/vehicle?vin={self.vin}&key=e6c1852eb5124b1890fbd17ad53e870a',
    ...
    def parse_vin_trim_driveway(self, response):
        ...
        try:
            ...
            if(self.condition=='Excellent' or self.condition=='excellent'):
                ...
                condition = 'GOOD'
            elif(self.condition=='Moderate' or self.condition=='moderate'):
                condition = 'FAIR'
            else:
                condition = 'POOR'
    ...
    def parse_driveway_offer(self, response, result):
        ...
        result['saleType'] = json_response['saleType']
        result['userAction'] = json_response['userAction']
        result['dealershipCode'] = json_response['dealershipCode']
        result['paymentDetails'] = json_response['paymentDetails']
